...
build-arduino-colorlamp:
	docker run --rm -v "$(PWD):/src" -v "$(GOPATH):/gohost" -e "GOPATH=$(GOPATH):/gohost" tinygo/tinygo:0.6.1 tinygo build -o /src/build/arduino-colorlamp.hex -target arduino /src/arduino-colorlamp/main.go
...
build-microbit-blink:
	docker run --rm -v "$(PWD):/src" -v "$(GOPATH):/gohost" -e "GOPATH=$(GOPATH):/gohost" tinygo/tinygo:0.6.1 tinygo build -o /src/build/microbit-blink.hex -target microbit /src/microbit-blink/main.go
...
build-microbit-pixelbuttons:
	docker run --rm -v "$(PWD):/src" -v "$(GOPATH):/gohost" -e "GOPATH=$(GOPATH):/gohost" tinygo/tinygo:0.6.1 tinygo build -o /src/build/microbit-pixelbuttons.hex -target microbit /src/microbit-pixelbuttons/main.go
...
build-reelboard-accel:
	docker run --rm -v "$(PWD):/src" -v "$(GOPATH):/gohost" -e "GOPATH=$(GOPATH):/gohost" tinygo/tinygo:0.6.1 tinygo build -o /src/build/reelboard-accel.hex -target reelboard /src/accel/main.go
...
build-nrf-colorlamp:
	docker run --rm -v "$(PWD):/src" -v "$(GOPATH):/gohost" -e "GOPATH=$(GOPATH):/gohost" tinygo/tinygo:0.6.1 tinygo build -o /src/build/nrf-colorlamp.hex -target pca10040 /src/nrf-colorlamp/main.go
